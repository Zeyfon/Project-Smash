    ...
    public class PlayerFighter : MonoBehaviour
    {
            ...
            while (true)
            {
                ...
                else if (counter == 1)
                {
                    ...
                    if (hit)
                    {
                        ...
                        hit.transform.GetComponent<IDamagable>().TakeDamage(transform, forwardAttackDamage);
        ...
        private void SendDamage(int damage)
        {
            ...
            foreach (Collider2D coll in colls)
            {
                ...
                coll.GetComponent<IDamagable>().TakeDamage(transform, damage);
            }
        }     
        ...
        IEnumerator SplashAttackDamage()
        {
            ...
            foreach (Collider2D coll in colls)
            {
                ...
                coll.GetComponent<IDamagable>().TakeDamage(transform, splashDamage);
            }
            yield return null;
        }
