...
namespace PSmash.Movement
{
    public class PlayerMovementV2 : MonoBehaviour
    {
        ...
        void CheckLedgeClimb()
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(transform.position + new Vector3(transform.right.x, 0), Vector2.up, 1.5f, whatIsClimbable);
            print(hit.collider.name);
            print(isTouchingMiddleWall.point + "  " + isTouchingUpperWall.point);
